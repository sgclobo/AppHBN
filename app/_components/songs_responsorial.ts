...
export const SONGS_RESPONSORIAL: Song[] = [
  {
    id: 50,
    category: "Misa",
    ...
    title: "UDAN BE TUN",
    language: "tet",
    refrain: "Udan be tun hosi lalehan mai sai habokon no haburas rai; nune'e mos Na'i nia futar lia sei halo tuir knaar Maksoin ba ema tomak.",
    verses: [
  ...
  },
  {
    ...
    title: "SE O RONA",
    language: "tet",
    refrain: "Na'i bolu ema wain; (2x) barak tempu la iha. (2x)",
    verses: [
  ...
  },
  {
    ...
    title: "RAHUN KMANEK",
    language: "tet",
    refrain: "Rahun kmanek ba ida nebe rona Na'i nia futar lia.",
    verses: [
  ...
  },
  {
    ...
    language: "tet",
    refrain: "Maromak liman los hatudu Nia kbiit. Maromak liman los foti ha'u. Ha'u sei la mate, moris beibeik. Hahi, ha na'i Na'i Maromak.",
    verses: [
  ...
  },
  {
    ...
    title: "MAI, KOKO BA",
    language: "tet",
    refrain: "Mai, koko ba hodi hare Na'i laran diak oin sa. (2x)",
    verses: [
  ...
  },
  {
    ...
    language: "tet",
    refrain: "Iha foho santu Na'i ninian ha'u rona lia idal bolu ha'u.",
    verses: [
