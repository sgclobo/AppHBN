...
export const SONGS_TEMPO_LITURGICO: Song[] = [
  ...
  },
  {
    ...
    language: "tet",
    refrain: "Mai, mai, Na'i Jesus: mai Na’i, ami hein Ita.\nMai, mai, Na’i Jesus: la lais, hiit an mai.",
    verses: [
  ...
  },
  {
    ...
    language: "tet",
    refrain: "Rona, Maromak, ema hakilar, tanis.\nRona, Kristu, mai, mai, sadia ami.",
    verses: [
      "1. Rai hotu terus teb-tebes. Mai, mai, sadia ami.\nBa Na’i Maromak hakilar: Mai, mai, sadia ami.",
  ...
  },
  {
    ...
    title: "QUANDO VIRA",
    language: "pt",
    refrain: "O ceus que ird se faga em salvagao e em graga.",
    verses: [
      "1. Quando vira, Senhor, o dia\nen que aparece o Salvador\ne soe brado de alegria\nnasceu do mundo o Redentor?",
  ...
  },
  {
    ...
    language: "pt",
    refrain: "Alegrem-se os céus e a terra,\ncantemos com alegria\nque nasceu o Deus Menino,\nFilho da Virgem Maria!",
    verses: [
  ...
  },
  {
    ...
    category: "Tempo Litúrgico",
    section: "Quaresma",
    title: "HANA'I, HAHI BA ITA BOOT",
    language: "tet",
    refrain: "Hana'i, hahi ba Ita Boot, Jesus Kristu, ami Na'i.",
    verses: [
  ...
  },
  {
    ...
    title: "HANOIN, SADIA",
    language: "tet",
    refrain: "Hanoin, sadia, ha'u Aman Maromak,\nPerdua ha'u nia sala",
    verses: [
      ...
      "5. Ha'u klamar fiar Nia tutor lia with laran metin.",
      "6. Ha'u klamar buka hein Maromak\ndiak liu ema hein rai hun mutin.",
      "7. Hanesan ema hein loron atu sa'e\nnune'e ita hein ita Na'i tan Nia laran luak."
    ]
  },
  {
    id: 802,
    ...
    language: "tet",
    refrain: "Ha'u Aman, ba Ita liman, ha'u klamar hasa'e.",
    verses: [
  ...
  },
  {
    ...
    language: "tet",
    refrain: "Ha'u klamar tau neon ba ha'u Na'i;\nMaromak mak ha'u nia laran metin",
    verses: [
  ...
  },
  {
    ...
    language: "tet",
    refrain: "Ha'u nia hena sira fahe ba malu:\nHa'u nia tunika sira dada sorti.",
    verses: [
  ...
  },
  {
    ...
    verses: [
      ...
      "7. Se los mak liurai boot; Ida be makaas iha funu."
    ]
  },
  {
    id: 807,
  ...
  },
  {
    ...
    language: "tet",
    refrain: "Hosana, Kristu manan; Iha krus, Kristu sei soi ita. (2x)",
    verses: [
  ...
  },
  {
    ...
    language: "tet",
    refrain: "Iha Ita liman, ha'u Aman, Ha'u saran ha'u nia espiritu.",
    verses: [
  ...
  },
  {
    ...
    language: "tet",
    refrain: "Ita harohan ba ita Na'i laran luak:\nNa'i, sadia ami; Na'i, sadia ami.",
    verses: [
  ...
  },
  {
    ...
    language: "tet",
    refrain: "Ita nia Maksoin mai hosi krus.\nJesus, ita Na'i, nia krus.",
    verses: [
  ...
  },
  {
    ...
    title: "JERUSALEM",
    language: "tet",
    refrain: "Jerusalem, Jerusalem, host dalan boot,\nJerusalem Kristu sai, lori krus. (2x)",
    verses: [
  ...
  },
  {
    ...
    language: "tet",
    refrain: "Na'i Jesus, ami hahi. (2x)",
    verses: [
  ...
  },
  {
    ...
    language: "tet",
    refrain: "Na'i Jesus, ami Maksoin, iha Ita ami nia salvasaun.\nLa'o lemo rai, la'o dalan, buka Ita Boot.",
    verses: [
  ...
  },
  {
    ...
    language: "tet",
    refrain: "Perdua, Na'i, perdua. Ami fiar Ita Boot.",
    verses: [
  ...
  },
  {
    ...
    title: "POVU DOBEN",
    language: "tet",
    refrain: "Povu doben, Ha'u halo sa?\nHalo sa aat ba o? Dehan took ba!",
    verses: [
  ...
  },
  {
    ...
    language: "tet",
    refrain: "Sadia ami, Na'i, ami nia Maksoin.",
    verses: [
  ...
  },
  {
    ...
    language: "tet",
    refrain: "Kristu moris hias fali, aleluia, aleluia.",
    verses: [
  ...
  },
  {
    ...
    language: "tet",
    refrain: "Kristu nia roman leno raiklaran tomak, aleluia, aleluia.",
    verses: [
  ...
  },
  {
    ...
    language: "tet",
    refrain: "Moris hias ona, aleluia.\nKristu Jesus iha ita leet.",
    verses: [
  ...
  },
  {
    ...
    language: "tet",
    refrain: "Na'i moris hias (3x) Aleluia (4x) Na'i moris hias.",
    verses: [
  ...
  },
  {
    ...
    verses: [
      ...
      "3. Tu septiformis munere, digitus paternae dexterae; Tu rite promissum Paths, sermone ditans guttura.",
  ...
  },
  {
    ...
    language: "pt",
    refrain: "O Espirito do Senhor renova a face da terra. Aleluia, aleluia.",
    verses: [
      "1. Vinde Espirito Santo, vinde Amor ardente, acendei na terra Vossa luz fulgente.",
      "2. Vinde, Pai dos pobres na dor e aflies, vinde encher de gozo nossos coraes.",
      "3. Benfeitor supremo em todo o momenta habitando em nos, sois o nosso alento.",
      "4. Descanso na luta e na paz encanto, no color sois brisa, conforto no pronto.",
      "5. Lavai nossas manchas, a aridez regai; sanai os infermos e a todos salvai.",
      "6. Abrandai durezas para os caminhantes; animai os tristes, guiai os errantes."
    ]
  },
  {
    id: 902,
    ...
    language: "tet",
    refrain: "Haruka Ita Boot nia Espiritu halo foun hikas rai tomak.",
    verses: [
      "1. Ha'uklamarhawelokha'uNa'i.\nNa'i, ha'u nia Maromak, Ita Boot tebes. Boat hotu Ita Boot hakiak nakonu iha rai.",
      "2. Ita Boot hasai karik Ita Boot nia Espiritu, sira mate, sira fila ba rai rahun; haruka Ita Boot nia Espiritu sira moris. Hafoun rai tomak nia ilas.",
