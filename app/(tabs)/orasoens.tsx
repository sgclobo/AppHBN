...
const prayers: Record<string, PrayerItem> = {
    ...
    "Nas Tentações": {
        ...
        "section": "Durante o Dia",
        "label": "Nas Tentações",
        "content": "«Vigiai e orai para não cairdes em tentação» – disse Jesus (Mt 26, 41).\nVigiai, isto é, fugi das ocasiões que podem levar ao pecado: certos programas de televisão, discotecas, espectáculos, leituras, conversas, divertimentos, malas companhias, excessos no comer e beber...\nOrai, isto é, rezai. Diz então: «Jesus, Maria, José!» ou: «Senhor, não nos deixeis cair em tentação!»"
    },
    "Leitura": {
        "id": "leitura",
        "title": "Leitura",
    ...
    "Reparação": {
        ...
        "section": "Sagrada Comunhão",
        "label": "Reparação",
        "content": "Meu Deus, eu creio, adoro, espero e amo-Vos. Peço-Vos perdão para os que não crêem, não adoram, não esperam e não Vos amam.\n\nSantíssima Trindade, Pai, Filho, Espírito Santo, adoro-Vos profundamente e ofereço-Vos o preciosíssimo Corpo, Sangue, Alma e Divindade de Jesus Cristo presente em todos os sacrários da terra, em reparação dos ultrajes, sacrilégios e indiferenças with which Ele mesmo é ofendido. E pelos mérito infinitos do seu Santíssimo Coração e do Coração Imaculado de Maria, peço-vos a conversão dos pobres pecadores."
    },
    "Fica, Senhor!": {
        "id": "fica_senhor",
        "section": "Sagrada Comunhão",
    ...
    "Confissão — Exame de Consciência": {
        ...
        "content": "1.º Mandamento – Rezei todos os dias? Contribuo para o culto? Falei contra Deus ou a religião? Duvidei da fé? Acreditei em superstições? Recebi a comunhão em pecado? Confessei-me au menos uma vez por ano?"
    },
