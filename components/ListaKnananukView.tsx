    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.pageTitle}>Lista Kântikus</Text>
                <View style={{ width: 40 }} />
            </View>
                            ...
                            <View key={category} style={styles.categoryCard}>
                                ...
                                {isExpanded && (
                                    <View style={styles.categoryBody}>
                                        {["Misa", "Tempo Litúrgico", "Maria no Santu Sira", "Suplementu"].includes(category) ? (
                                            (() => {
                                                const order = category === "Misa" 
                                                    ? ['Entrada', 'Responsorial', 'Aleluia', 'Ofertório', 'Sanctus', 'Comunhão', 'Ação de Graças', 'Final', 'Misa Latin']
                                                    : category === "Tempo Litúrgico"
                                                    ? ['Advento', 'Natal', 'Quaresma', 'Páscoa', 'Pentecostes']
                                                    : category === "Maria no Santu Sira"
                                                    ? ['Maria', 'Santu Sira']
                                                    : ['Tetum', 'Portugues', 'Bahasa', 'Inglês', 'Espanhol'];
