...
export const SONGS_MISA_TETUM: Song[] = [
  {
    id: 1,
    category: "Misa",
    section: "Entrada",
  ...
  },
  {
    ...
    language: "tet",
    refrain: "Hamutuk ho mundu tomak ita hahi ba ita Na'i.\nAleluia, ita haklaken justisa, paz no hadomi.",
    verses: [
  ...
  },
  {
    ...
    language: "tet",
    refrain: "Lalehan rai foun Na'i sei to mai.\njustisa nakonu iha mundu be sei mai.",
    verses: [
  ...
  },
  {
    ...
    language: "tet",
    refrain: "Maromak, Ita mak bolu no ami la'o to'o mai;\nIta nia liafuan haksolok ami laran. (2x)",
    verses: [
  ...
  },
  {
    ...
    language: "tet",
    refrain: "Bidu, ho ksolok, hananu hahi Na'i!\nBidu, ho ksolok, hawelok Nia naran;\nraiklaran tomak haktuir Na'i nia beran\nhodi lia dadolin!\nRai ulun, rai ikun, tuku tur,\nhahi Na'i nia kmanek mesak oi-oin!\nBidu ho tebe, hananu hahi Na'i!\nBidu, ho ksolok, hawelok nia naran!",
    verses: [
  ...
  },
  {
    ...
    language: "tet",
    refrain: "Rahun diak ba ida be mai hodi Na'i nia naran.",
    verses: [
